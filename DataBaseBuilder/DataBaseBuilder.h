...
public:
	...
	bool RequestImageHashesForDir(string galleryPath, int galleryID, /*NetUtils *conn,*/ int connIndex);
	bool RequestImageHash(string imgPath, int galleryID, /*NetUtils*conn,*/ int connIndex);
};